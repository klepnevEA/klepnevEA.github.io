...
const CustomSelect=(h=>{const i={block:"custom-select",hideCallback:!1,includeValue:!1,keyboard:!0,modifier:!1,placeholder:!1,search:!1,showCallback:!1,transition:0};class e{constructor(t,s){this._$select=h(t),this._options={...i,..."object"==typeof s?s:{}},this._activeModifier=`${this._options.block}--active`,this._dropupModifier=`${this._options.block}--dropup`,this._optionSelectedModifier=`${this._options.block}__option--selected`,this._keydown=this._keydown.bind(this),this._dropup=this._dropup.bind(this),this._outside=this._outside.bind(this),this._init()}reset(){this._$dropdown.hide().empty(),this._$value.off("click"),this._fill()}_init(){this._$element=h(`<div class="${this._options.block}">
           <button class="${this._options.block}__option ${this._options.block}__option--value" type="button"></button>
           <div class="${this._options.block}__dropdown" style="display: none;"></div>
         </div>`),this._$select.hide().after(this._$element),this._options.modifier&&this._$element.addClass(this._options.modifier),this._$value=this._$element.find(`.${this._options.block}__option--value`),this._$dropdown=this._$element.find(`.${this._options.block}__dropdown`),this._fill()}_fill(){this._$values=this._$select.find("option"),this._values=[];let n=this._options.placeholder;h.each(this._$values,(t,s)=>{s=h(s).text().trim();this._values.push(s)}),n&&(this._$select.find("[selected]").length?n=!1:(this._$value.html(n),this._$select.prop("selectedIndex",-1))),h.each(this._values,(t,s)=>{var i=this._$values.eq(t).attr("class");const e=h(`<button class="${this._options.block}__option" type="button">${s}</button>`),o=this._$select.find(":selected");this._$values.eq(t).attr("disabled")&&e.prop("disabled",!0),!o.length&&0===t||s===o.text().trim()?(n||this._$value.text(s).removeClass(this._$value.data("class")).removeData("class").addClass(i).data("class",i),(this._options.includeValue||n)&&(e.addClass(i),e.toggleClass(this._optionSelectedModifier,this._$values.eq(t).is("[selected]")),this._$dropdown.append(e))):(e.addClass(i),this._$dropdown.append(e))}),this._$options=this._$dropdown.find(`.${this._options.block}__option`),this._options.search&&this._search(),this._$value.one("click",t=>{this._show(t)}),this._$value.prop("disabled",!this._$options.length),this._$options.on("click",t=>{this._select(t)})}_show(t){t.preventDefault(),this._dropup(),h(window).on("resize scroll",this._dropup),this._$element.addClass(this._activeModifier),this._$dropdown.slideDown(this._options.transition,()=>{this._options.search&&(this._$input.focus(),this._options.includeValue&&this._scroll()),"function"==typeof this._options.showCallback&&this._options.showCallback.call(this._$element[0])}),setTimeout(()=>{h(document).on("touchstart click",this._outside)},0),this._$value.one("click",t=>{t.preventDefault(),this._hide()}),this._options.keyboard&&(this._options.index=-1,h(window).on("keydown",this._keydown))}_hide(){this._options.search&&(this._$input.val("").blur(),this._$options.show(),this._$wrap.scrollTop(0)),this._$dropdown.slideUp(this._options.transition,()=>{this._$element.removeClass(this._activeModifier).removeClass(this._dropupModifier),"function"==typeof this._options.hideCallback&&this._options.hideCallback.call(this._$element[0]),this._$value.off("click").one("click",t=>{this._show(t)}),h(document).off("touchstart click",this._outside),h(window).off("resize scroll",this._dropup)}),this._options.keyboard&&(this._$options.blur(),h(window).off("keydown",this._keydown))}_scroll(){h.each(this._$options,(t,s)=>{const i=h(s);if(i.text()===this._$value.text()){var e=i.position().top,s=this._$wrap.outerHeight()/2-i.outerHeight()/2;return s<e&&this._$wrap.scrollTop(e-s),!1}})}_select(t){t.preventDefault();const e=h(t.currentTarget).text().trim(),o=[...this._values];if(this._$value.text(e).removeClass(this._$value.data("class")),this._$values.prop("selected",!1),h.each(o,(t,s)=>{this._options.includeValue||s!==e||o.splice(t,1),h.each(this._$values,(t,s)=>{const i=h(s);i.text().trim()===e&&(s=i.attr("class"),i.prop("selected",!0),this._$value.addClass(s).data("class",s))})}),this._hide(),this._options.includeValue)this._$options.removeClass(this._optionSelectedModifier),h.each(this._$options,(t,s)=>{const i=h(s);if(i.text().trim()===e)return i.addClass(this._optionSelectedModifier),!1});else{if(this._$options.length>o.length){const s=this._$options.eq(o.length);s.remove(),this._$options=this._$options.not(s),this._$options.length||this._$value.prop("disabled",!0)}h.each(this._$options,(s,t)=>{const i=h(t);i.text(o[s]),i.attr("class",`${this._options.block}__option`),h.each(this._$values,function(){const t=h(this);t.text().trim()===o[s]&&(i.addClass(t.attr("class")),i.prop("disabled",t.prop("disabled")))})})}void 0!==t.originalEvent&&this._$select.trigger("change")}_search(){this._$input=h(`<input class="${this._options.block}__input" autocomplete="off">`),this._$dropdown.prepend(this._$input),this._$options.wrapAll(`<div class="${this._options.block}__option-wrap"></div>`),this._$wrap=this._$element.find(`.${this._options.block}__option-wrap`),this._$input.on("focus",()=>{this._options.index=-1}),this._$input.on("keyup",()=>{const o=this._$input.val().trim();o.length?(this._$wrap.scrollTop(0),setTimeout(()=>{o===this._$input.val().trim()&&h.each(this._$options,(t,s)=>{const i=h(s),e=i.text().trim().toLowerCase();s=-1!==e.indexOf(o.toLowerCase());i.toggle(s)})},300)):this._$options.show()})}_dropup(){var t=this._$element[0].getBoundingClientRect().bottom,t=h(window).height()-t<this._$dropdown.height();this._$element.toggleClass(this._dropupModifier,t)}_outside(t){const s=h(t.target);s.parents().is(this._$element)||s.is(this._$element)||this._hide()}_keydown(t){const s=this._$options.filter(":visible").not("[disabled]");switch(t.which){case 40:t.preventDefault(),s.eq(this._options.index+1).length?this._options.index+=1:this._options.index=0,s.eq(this._options.index).focus();break;case 38:t.preventDefault(),s.eq(this._options.index-1).length&&0<=this._options.index-1?--this._options.index:this._options.index=s.length-1,s.eq(this._options.index).focus();break;case 13:case 32:if(!this._$input||!this._$input.is(":focus")){t.preventDefault();const i=this._$options.add(this._$value).filter(":focus");i.trigger("click"),i.is(this._$value)||this._$select.trigger("change"),this._$value.focus()}break;case 27:t.preventDefault(),this._hide(),this._$value.focus()}}static _jQueryPlugin(i){return this.each(function(){const t=h(this);let s=t.data("custom-select");s?"reset"===i&&s.reset():"string"!=typeof i&&(s=new e(this,i),t.data("custom-select",s))})}}return h.fn.customSelect=e._jQueryPlugin,h.fn.customSelect.noConflict=()=>h.fn.customSelect,e})($);
document.addEventListener("DOMContentLoaded",function(){$(".select").customSelect({transition:200}),$("#main-slider").slick({nextArrow:$("#next-arrow"),prevArrow:$("#prew-arrow"),dots:!0,appendDots:$(".main-slider__dots")});var e=()=>{$("#body").toggleClass("open-aside-menu")};$("#aside-menu-button").on("click",e),$("#close-button").on("click",e)});