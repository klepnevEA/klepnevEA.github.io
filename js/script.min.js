...
document.addEventListener("DOMContentLoaded",function(){$("#main-slider").slick({nextArrow:$("#next-arrow"),prevArrow:$("#prew-arrow"),dots:!0,appendDots:$(".main-slider__dots")});var e=()=>{$("#body").toggleClass("open-aside-menu")};$("#aside-menu-button").on("click",e),$("#close-button").on("click",e)});