...
document.addEventListener("DOMContentLoaded",function(){$("#button-mobile-menu").on("click",e=>{e.preventDefault(),$("#header").toggleClass("active")}),$(".nav__link").on("click",e=>{$("#header").removeClass("active")});const i=e=>{e=(e+1)/$("#main-slider").slick("getSlick").slideCount*100;$("#main-slider-scrollbar").css("background-size",e+"% 100%").attr("aria-valuenow",e)},e=($("#main-slider").on("beforeChange",(e,a,t,s)=>{i(s)}),$("#main-slider").slick({speed:500,fade:!0,cssEase:"linear",autoplay:!0,autoplaySpeed:7500,asNavFor:"#slider-baner",arrows:!0,prevArrow:$("#main-slider-arrow-left"),nextArrow:$("#main-slider-arrow-right")}),$("#slider-baner").slick({speed:500,fade:!0,cssEase:"linear",autoplay:!0,autoplaySpeed:7500,arrows:!0,asNavFor:"#main-slider",prevArrow:$("#main-slider-arrow-left"),nextArrow:$("#main-slider-arrow-right")}),i(0),document.querySelectorAll("section")),a=document.querySelectorAll(".nav__item");$(".scroll-to").on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-50},500)});$(".nav__link").on("click",e=>{var a;a=e,$(".nav__link").removeClass("active"),setTimeout(()=>{$(a.target.closest(".nav__item")).addClass("active")},500)});window.addEventListener("scroll",()=>{let t="";e.forEach(e=>{var a=e.offsetTop;e.clientHeight;scrollY>=a-500&&(t=e.getAttribute("id"))}),a.forEach(e=>{e.classList.remove("active"),e.classList.contains(t)&&e.classList.add("active")})});$(".what-have-item").on("click",e=>{return e=(e=e).target.closest(".what-have-item"),a=e.getAttribute("data-item"),$(".what-have-item").removeClass("active"),$(".what-have-slide").removeClass("active"),$(e).addClass("active"),void $("#"+a).addClass("active");var a});$(".cases-item").on("click",e=>{return e=(e=e).target.closest(".cases-item"),a=e.getAttribute("data-case"),$(".cases-item").removeClass("active"),$(".cases-slide").removeClass("active"),$(e).addClass("active"),void $("#"+a).addClass("active");var a})});